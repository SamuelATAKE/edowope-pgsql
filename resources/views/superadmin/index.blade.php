          ...
          <div class="home-tab">
            <div class="d-sm-flex align-items-center justify-content-between border-bottom">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Quelques stats</a>
                </li>
              </ul>
              <div>
                              ...
                              <table class="table select-table">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      <div class="d-flex ">
                                        <img src="superadmin/images/faces/face1.jpg" alt="">
                                        <div>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="d-flex">
                                        <img src="superadmin/images/faces/face2.jpg" alt="">
                                        <div>
                                          <h6>Laura Brooks</h6>
                                          <p>Head admin</p>
                                        </div>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="d-flex">
                                        <img src="superadmin/images/faces/face3.jpg" alt="">
                                        <div>
                                          <h6>Wayne Murphy</h6>
                                          <p>Head admin</p>
                                        </div>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="d-flex">
                                        <img src="superadmin/images/faces/face4.jpg" alt="">
                                        <div>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="d-flex">
                                        <img src="superadmin/images/faces/face5.jpg" alt="">
                                        <div>
                              ...
                              <div class="col-lg-12">
                                ...
                                <div class="mt-3">
                                  <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                    <div class="d-flex">
                                      <img class="img-sm rounded-10" src="superadmin/images/faces/face1.jpg" alt="profile">
                                  ...
                                  <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                    <div class="d-flex">
                                      <img class="img-sm rounded-10" src="superadmin/images/faces/face2.jpg" alt="profile">
                                      <div class="wrapper ms-3">
                                  ...
                                  <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                    <div class="d-flex">
                                      <img class="img-sm rounded-10" src="superadmin/images/faces/face3.jpg" alt="profile">
                                      <div class="wrapper ms-3">
                                  ...
                                  <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                    <div class="d-flex">
                                      <img class="img-sm rounded-10" src="superadmin/images/faces/face4.jpg" alt="profile">
                                      <div class="wrapper ms-3">
                                  ...
                                  <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                    <div class="d-flex">
                                      <img class="img-sm rounded-10" src="superadmin/images/faces/face5.jpg" alt="profile">
                                      <div class="wrapper ms-3">
